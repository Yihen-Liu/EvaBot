...
func NewChatInviteLink(chatID int64)  ChatInviteLinkConfig{
	return ChatInviteLinkConfig{
...
func NewRevokeChatInviteLink(chatID int64, link string) RevokeChatInviteLinkConfig {
